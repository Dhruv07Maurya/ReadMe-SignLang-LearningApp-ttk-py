...
label1=Label(w, text='         Read-Me', fg='white', bg='#272727') #decorate it
label1.configure(font=("Palatino", 24, "bold"))   #You need to install this font in your PC or try another one
